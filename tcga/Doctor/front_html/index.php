<main style="margin-top: 0.1%;">
	<div class="container">
		...
		<div class="row">
			<div class="row">
		    <form class="col s4" method="get" action="/Doctor/insert.php">	     	      
		     ...
		     <form class="col s4" method="get" action="/Doctor/insert.php">
		        <div class="input-field col s9">
		          <i class="material-icons prefix">search</i>		        	
		          <input id="passname" type="text" class="validate" name="passname">
		          <label for="passname">请输入姓名</label>
		        </div>
		        <div class="input-field col s3">
		      		<input type="submit" class="btn green"/>
		      	</div>
		     ...
		     <form class="col s4" method="get" action="/Doctor/insert.php">
		        <div class="input-field col s9">
		          <i class="material-icons prefix">search</i>		        	
		          <input id="password" type="text" class="validate" name="hospital_number">
		          <label for="hospital_number">请输入住院号</label>
		        </div>
		        <div class="input-field col s3">
		      		<input type="submit" class="btn green"/>
		      	</div>
	...
	<div style="margin-left: 1%;">
		...
		<table class="responsive-table highlight bordered">
	        ...
	        <tbody>
				...
				<td><?php echo $v['number_hospital'];?></td>
