			            ...
			            <td>
			            	...
			            	<a class="waves-effect waves-light btn operator_delete" attr-id="<?=$store['case_id']?>" attr-card="">
			            		<i class="fa fa-close fa-fw"></i>删除</a>
											<a class="waves-effect waves-light btn" href="/Operator/index.php?action=view&id=<?php echo $v['diagnosis_id'];?>&name=<?php echo $v['username'];?>&ID=<?=$v['ID_card']?>"><i class="fa fa-eye fa-fw"></i>详情</a>
					            <a class="waves-effect waves-light btn" href="/Operator/index.php?action=add&id=<?php echo $v['diagnosis_id'];?>&name=<?php echo $v['username'];?>&ID=<?=$v['ID_card']?>"><i class="fa fa-edit fa-fw"></i>修改</a>
			            </td>
			          </tr>
				<?php
					}else{
